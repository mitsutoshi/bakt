...
class SampleStrategy(Strategy):
    ...
    def think(self,
        ...
        order_delay_sec = float(user_settings['order_delay_sec'])
        order_expire_sec = float(user_settings['order_expire_sec'])
